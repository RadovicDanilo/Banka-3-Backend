...
func (x *ForexPair) Reset() {
	*x = ForexPair{}
	mi := &file_trading_forex_proto_msgTypes[0]
...
func (*ForexPair) Descriptor() ([]byte, []int) {
	return file_trading_forex_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListForexPairsRequest) Reset() {
	*x = ListForexPairsRequest{}
	mi := &file_trading_forex_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListForexPairsRequest) Descriptor() ([]byte, []int) {
	return file_trading_forex_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListForexPairsResponse) Reset() {
	*x = ListForexPairsResponse{}
	mi := &file_trading_forex_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListForexPairsResponse) Descriptor() ([]byte, []int) {
	return file_trading_forex_proto_rawDescGZIP(), []int{2}
}
...
var File_trading_forex_proto protoreflect.FileDescriptor

const file_trading_forex_proto_rawDesc = "" +
	"\n" +
	"\x13trading/forex.proto\x12\atrading\"\xcf\x02\n" +
	"\tForexPair\x12\x0e\n" +
	...
	"\x05pairs\x18\x01 \x03(\v2\x12.trading.ForexPairR\x05pairsB:Z8github.com/RAF-SI-2025/Banka-3-Backend/pkg/proto/tradingb\x06proto3"

var (
	file_trading_forex_proto_rawDescOnce sync.Once
	file_trading_forex_proto_rawDescData []byte
)

func file_trading_forex_proto_rawDescGZIP() []byte {
	file_trading_forex_proto_rawDescOnce.Do(func() {
		file_trading_forex_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trading_forex_proto_rawDesc), len(file_trading_forex_proto_rawDesc)))
	})
	return file_trading_forex_proto_rawDescData
}

var file_trading_forex_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_trading_forex_proto_goTypes = []any{
	(*ForexPair)(nil),              // 0: trading.ForexPair
	(*ListForexPairsRequest)(nil),  // 1: trading.ListForexPairsRequest
	(*ListForexPairsResponse)(nil), // 2: trading.ListForexPairsResponse
}
var file_trading_forex_proto_depIdxs = []int32{
	0, // 0: trading.ListForexPairsResponse.pairs:type_name -> trading.ForexPair
...
func init() { file_trading_forex_proto_init() }
func file_trading_forex_proto_init() {
	if File_trading_forex_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trading_forex_proto_rawDesc), len(file_trading_forex_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_trading_forex_proto_goTypes,
		DependencyIndexes: file_trading_forex_proto_depIdxs,
		MessageInfos:      file_trading_forex_proto_msgTypes,
	}.Build()
	File_trading_forex_proto = out.File
	file_trading_forex_proto_goTypes = nil
	file_trading_forex_proto_depIdxs = nil
}
