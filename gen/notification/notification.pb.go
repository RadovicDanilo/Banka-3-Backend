...
func (x *CardCreatedMailRequest) GetCardNumber() string {
	if x != nil {
		return x.CardNumber
	}
	return ""
...
func (x *CardCreatedMailRequest) GetCardType() string {
	if x != nil {
		return x.CardType
	}
	return ""
