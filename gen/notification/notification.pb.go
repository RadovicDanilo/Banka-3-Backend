...
const file_notification_notification_proto_rawDesc = "" +
	...
	"\x19SendCardConfirmationEmail\x12).notification.CardConfirmationMailRequest\x1a\x1d.notification.SuccessResponseB9Z7github.com/RAF-SI-2025/Banka-3-Backend/gen/notificationb\x06proto3"
...
var file_notification_notification_proto_goTypes = []any{
	...
	(*SuccessResponse)(nil),             // 4: notification.SuccessResponse
}
var file_notification_notification_proto_depIdxs = []int32{
	...
	4, // 5: notification.NotificationService.SendConfirmationEmail:output_type -> notification.SuccessResponse
	4, // 6: notification.NotificationService.SendActivationEmail:output_type -> notification.SuccessResponse
	4, // 7: notification.NotificationService.SendPasswordResetEmail:output_type -> notification.SuccessResponse
	4, // 8: notification.NotificationService.SendInitialPasswordSetEmail:output_type -> notification.SuccessResponse
	4, // 9: notification.NotificationService.SendCardConfirmationEmail:output_type -> notification.SuccessResponse
